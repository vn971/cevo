...
begin
  BitBltUgly(Canvas, 0, 0, ClientWidth,
...
begin
  ...
  begin
    ...
    Frame(Canvas, CaptionLeft + 1, 0 + 1,
      ClientWidth - CaptionLeft - 2, TitleHeight - 1, MainTexture.clBevelLight,
    ...
    begin
      ...
      Frame(Canvas, CaptionLeft + 1, ClientHeight - WideFrame - 1 + 1,
        ClientWidth - CaptionLeft - 2, ClientHeight - 2, MainTexture.clBevelLight,
        MainTexture.clBevelShade);
  ...
  BitBltUgly(Canvas, SideFrame, TitleHeight, ClientWidth - 2 * SideFrame,
...
begin
  ...
  if WideBottom then
  begin
    r1 := CreateRectRgn(0, ClientHeight - (WideFrame - NarrowFrame), CaptionLeft, ClientHeight);
    CombineRgn(r0, r0, r1, RGN_DIFF);
    //DeleteObject(r1);
    r1 := CreateRectRgn(ClientWidth - CaptionLeft, ClientHeight -
      (WideFrame - NarrowFrame), ClientWidth, ClientHeight);
    CombineRgn(r0, r0, r1, RGN_DIFF);
    //DeleteObject(r1);
  end;
