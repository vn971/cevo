          ...
          begin
            ...
            if icon >= 0 then
              BitBltTransparent(offscreen.Canvas, 104 - 33 + 15 + 3 + TechNameSpace + 24 * j, y0 + 3,
                14, 14, 67 + icon * 15, 85, system1transparent)
  ...
  begin // show nation under cursor position
    ...
    begin
      ...
      begin
        ...
        BitBltUgly(ScienceNationDot.Canvas.Handle, 0, 0, 17, 17, Canvas.Handle, xScreen - 10,
