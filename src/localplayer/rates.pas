...
begin
  ...
  begin
    ...
    RFrame(Offscreen.Canvas, x - 2, y - 2, x + max + 1, y + 8, MainTexture.clBevelShade,
    ...
    PaintProgressBar(Offscreen.Canvas, 5, 16 + 160, 81, MyRO.LuxRate * 120 div
      100, 0, 120, MainTexture);
  ...
  PaintProgressBar(Offscreen.Canvas, 0, 16 + 80, 201, MyRO.TaxRate * 120 div
    100, 0, 120, MainTexture);
