...
begin
  ...
  begin
    if List.Lines.Count = MaxLines then
      List.Lines.Delete(0);
    List.Lines.Add(char(48 + Turn div 100 mod 10) + char(48 + Turn div 10 mod 10) +
      char(48 + Turn mod 10) + ' ' + Text);
...
procedure TLogDlg.FormKeyDown(Sender: TObject; var Key: word; Shift: TShiftState);
begin
  if Host <> nil then
