...
type
  ...
  TCmdList = class
    ...
    procedure PutDataChanges(Command, Player: integer; OldData, NewData: pointer;
      DataSize: integer);
...
begin
  ...
  begin
    ...
    begin
      code := cardinal(Command - sExecute) shl 2 + cardinal(Player) shl
        16 + cardinal(Subject) shl 20;
      PutData(@code, 4);
    end;
  end;
  if Command and $f <> 0 then
